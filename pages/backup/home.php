<!-- Add preconnect and preload hints in the head section -->
<link rel="preconnect" href="https://fonts.gstatic.com">
<link rel="preconnect" href="https://cdnjs.cloudflare.com">
<link rel="preconnect" href="https://cdn.jsdelivr.net">
<link rel="preconnect" href="https://images.pexels.com">

<!-- Optional: Preload critical font -->
<link rel="preload" href="https://fonts.gstatic.com/s/roboto/v30/KFOlCnqEu92Fr1MmEU9fBBc4.woff2" as="font" type="font/woff2" crossorigin>

<!-- Consider moving these to critical CSS or load asynchronously -->
...
<script type="application/ld+json">
{
  ...
  "@type": "Organization",
  "name": "Brahmanbaria Govt. College Science Club",
  "alternateName": "BGC Science Club",
  "url": "https://bgcscienceclub.org",
  "logo": "https://bgcscienceclub.org/logo.jpg",
  "sameAs": [
    "https://www.facebook.com/61574939775582/",
    "https://www.youtube.com/@BGCScienceClub"
  ],
  "description": "Official science club of Brahmanbaria Government College promoting scientific activities among students. Nabil Bin Billal is serving as the secretary of Brahmanbaria Govt. College Science Club and developed and maintains its official website.",
  "founder": {
    "@type": "Person",
  ...
  "subOrganization": {
    "@type": "Organization",
    "name": "Bidibo Tech",
    "url": "https://bidibotech.vercel.app",
    "description": "Provides the technology platform and support for the BGC Science Club website."
  }
}
</script>
...
<section class="hero flex items-center justify-center">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 slide-in-up">Welcome to Brahmanbaria Govt. College Science Club</h1>
        ...
        <a href="/join" class="bg-green-500 hover:bg-green-600 text-white font-semibold px-6 py-3 rounded-md inline-block transition-all duration-300 ease-in-out transform hover:scale-110 hover:shadow-lg slide-in-up">
            Join Us Today
        </a>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php foreach ($recentProjects as $index => $project): 
                ...
                // Add fetchpriority=high for first image (LCP candidate)
            ...
            <article class="bg-gray-50 dark:bg-gray-900 rounded-2xl shadow hover:shadow-lg transition overflow-hidden <?php echo $hiddenClass; ?>" data-home-project-card>
                <img 
                    ...
                    onerror="this.src='https://images.pexels.com/photos/256381/pexels-photo-256381.jpeg?auto=compress&cs=tinysrgb&w=600'"
                >
                <div class="p-6">
                ...
                foreach ($activities as $activity) {
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden shadow-md activity-card animate-on-scroll">
                        <?php if (!empty($activity['image'])): ?>
                            <img 
                                src="<?php echo 'uploads/activities/' . $activity['image']; ?>" 
                                alt="<?php echo htmlspecialchars($activity['title']); ?>" 
                                class="w-full h-48 object-cover"
                                loading="lazy"
                                onerror="this.src='https://images.pexels.com/photos/3862130/pexels-photo-3862130.jpeg?auto=compress&cs=tinysrgb&w=600'"
                            >
                        <?php else: ?>
                            <img 
  ...
  Executive Committee
        ...
        <div class="relative group">
            ...
            <div class="flex justify-between absolute inset-0 z-10 items-center pointer-events-none">
                <button class="executive-prev bg-white dark:bg-gray-700 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-gray-600 pointer-events-auto opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300" name="ArrowButton">
                ...
                <button class="executive-next bg-white dark:bg-gray-700 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-gray-600 pointer-events-auto opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300" name="ArrowButton">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="flex">
                    ...
                    if ($totalExecutives > 0) {
                        ...
                        foreach (array_merge($executives, $executives, $executives, $executives) as $executive) {
                            $photoSrc = !empty($executive['profile_pic']) ? '/uploads/executives/' . htmlspecialchars($executive['profile_pic']) : 'assets/images/default-avatar.webp';
                            ?>
                                ...
                                <a href="/executive/<?php echo htmlspecialchars($executive['slug']); ?>" class="block">
                                    <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:scale-105 h-full">
                                        <img 
                                            ...
                                            class="w-full h-48 object-cover"
                                            loading="lazy"
                                            onerror="this.src='assets/images/default-avatar.webp'"
                                        >
                                        <div class="p-4">
...
<section class="py-16 bg-white dark:bg-gray-800 transition-colors duration-200">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative group">
            <!-- Navigation Buttons -->
            <div class="flex justify-between absolute inset-0 z-10 items-center pointer-events-none">
                <button class="member-prev bg-white dark:bg-gray-700 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-gray-600 pointer-events-auto opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300" name="ArrowButton">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button class="member-next bg-white dark:bg-gray-700 p-2 rounded-full shadow-md hover:bg-gray-100 dark:hover:bg-gray-600 pointer-events-auto opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300" name="ArrowButton">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-800 dark:text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    </svg>
                </button>
                ...
                <div class="flex">
                    ...
                    if ($totalMembers > 0) {
                        foreach (array_merge($members, $members, $members, $members) as $member) {
                            $photoSrc = !empty($member['profile_pic']) ? 'uploads/members/' . htmlspecialchars($member['profile_pic']) : 'assets/images/default-avatar.webp';
                            ?>
                            <div class="flex-shrink-0 w-64 px-2">
