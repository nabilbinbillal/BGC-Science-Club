...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] === 0) {
        ...
        // Prefer the centralized upload helper which compresses + optionally converts to WebP
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <?php if (isset($project) && $project['image']): ?>
                <?php $disp = function_exists('pickBestUploadFilename') ? pickBestUploadFilename('projects', $project['image']) : $project['image']; ?>
                <img src="../uploads/projects/<?php echo htmlspecialchars($disp); ?>" alt="Project Image" class="h-16 mt-2 rounded">
            <?php endif; ?>
        </div>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                <?php foreach ($projects as $prj): ?>
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <?php if ($prj['image']): ?>
                                <?php $disp = function_exists('pickBestUploadFilename') ? pickBestUploadFilename('projects', $prj['image']) : $prj['image']; ?>
                                <img src="../uploads/projects/<?php echo htmlspecialchars($disp); ?>" alt="Project Image" class="h-10 rounded">
                            <?php endif; ?>
                        </td>
