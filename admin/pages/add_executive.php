...
// include site helpers (ensure upload helper is available)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($_FILES['profile_pic']['name']) && $_FILES['profile_pic']['error'] === UPLOAD_ERR_OK) {
        ...
        if ($_FILES['profile_pic']['size'] > $max_size) {
            ...
            // Use centralized helper (compress and convert to webp when beneficial)
            $uploadResult = uploadMemberImage($_FILES['profile_pic'], $upload_dir);
            if ($uploadResult) {
